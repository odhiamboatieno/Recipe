    	...
    	if ($total_featured >= 10) {
	        $failed =<<<EOF
	            <script>
	                ...
	                window.location = 'manage-featured.php';
	            </script>
EOF;
        echo $failed;
    	} else {
...
?>
	...
	<?php 
		...
		if (empty($keyword)) {
			$sql_query = "SELECT n.recipe_id, n.recipe_title, n.recipe_image, n.recipe_time, c.category_name, n.video_id, n.content_type, n.featured, n.last_update
					FROM tbl_recipes n
			...
			$sql_query = "SELECT n.recipe_id, n.recipe_title, n.recipe_image, n.recipe_time, c.category_name, n.video_id, n.content_type, n.featured, n.last_update
					FROM tbl_recipes n
						LEFT JOIN tbl_category c ON n.cat_id = c.cid
					WHERE n.featured = '1' AND n.recipe_title LIKE ? 
					GROUP BY n.recipe_id  
					ORDER BY n.last_update DESC";
		}
		...
		if (empty($keyword)) {
			$sql_query = "SELECT n.recipe_id, n.recipe_title, n.recipe_image, n.recipe_time, c.category_name, n.video_id, n.content_type, n.featured, n.last_update
					...
					WHERE n.featured = '1'
					GROUP BY n.recipe_id  
					ORDER BY n.last_update DESC LIMIT ?, ?";
		} else {
			$sql_query = "SELECT n.recipe_id, n.recipe_title, n.recipe_image, n.recipe_time, c.category_name, n.video_id, n.content_type, n.featured, n.last_update
					FROM tbl_recipes n
						LEFT JOIN tbl_category c ON n.cat_id = c.cid
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
										...
										<tr>
							            	...
							            	<td><center>
							            		<?php if ($data['featured'] == '0') { ?>
							            			<a href="manage-featured.php?add=<?php echo $data['recipe_id'];?>" onclick="return confirm('Add to featured recipes?')" ><i class="material-icons" style="color:grey">lens</i></a>
							            		<?php } else { ?>
							            			<a href="manage-featured.php?remove=<?php echo $data['recipe_id'];?>" onclick="return confirm('Remove from featured recipes?')" ><i class="material-icons" style="color:#2196f3">lens</i></a>
							            		<?php } ?>
											</center></td>
							...
							<h4><?php $function->doPages($offset, 'manage-featured.php', '', $total_records, $keyword); ?></h4>
							<?php 
								}
							?>
						</div>
